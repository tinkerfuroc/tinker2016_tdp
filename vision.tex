...
\begin{figure} 
	\centering 
	\subfigure[Origin 1]{\label{fig:subfig:a}
		\includegraphics[width=0.385\linewidth]{images/1.png}}
	\hspace{0.01\linewidth}
	\subfigure[Result 1]{\label{fig:subfig:b}
		\includegraphics[width=0.45\linewidth]{images/1.jpg}}
	\vfill
	\subfigure[Origin 2]{\label{fig:subfig:a}
		\includegraphics[width=0.38\linewidth]{images/2.png}}
	\hspace{0.01\linewidth}
	\subfigure[Result 2]{\label{fig:subfig:b}
		\includegraphics[width=0.465\linewidth]{images/2.jpg}}
